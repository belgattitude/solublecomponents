...
Assuming you successfully [installed Normalist](../installation) with the instructions listed in the previous chapter.

## Creating a TableManager instance.

First of all, you need to have a TableManager instance configured with your database connection. 
...
function getTableManager() {
	...
	$tm = new TableManager(new ZeroConfDriver($adapter));
}
