...
class RecordTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetTable()
    {
        ...
        $record = $table->insertOnDuplicateKey($data, ['legacy_mapping']);
    ...
    public function test__Get()
    {
        ...
        $new_record = $medias->insertOnDuplicateKey($data, ['legacy_mapping']);
    ...
    public function testSaveThrowsDuplicateEntryException()
    {
        ...
        $medias->insertOnDuplicateKey($data2, ['legacy_mapping']);


        $medias->insertOnDuplicateKey($data, ['legacy_mapping']);
    ...
    public function testSaveCheckStates()
    {
        ...
        $tobedeleted = $medias->findOneBy(['legacy_mapping' => 'phpunit_testSaveCheckState']);
        if ($tobedeleted) {
            $tobedeleted->delete();
        }
