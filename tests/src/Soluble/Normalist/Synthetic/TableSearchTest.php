...
class TableSearchTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $results = $this->table->search()->columns(['reference'])->limit(1)->toArray();
    ...
    {
        $results = $this->table->search()->columns(['aliased_reference' => 'reference'])->limit(1)->toArray();
        $keys = array_keys($results[0]);
        $this->assertEquals(1, count($keys));
    ...
    public function testIncompletColumnsThrowsLogicException()
    {
        ...
        $rs = $this->table->search()->columns(['reference'])->limit(1)->execute();
    ...
    public function testWhere()
    {
        ...
        $results = $this->table->search()
                        ->where(['reference' => 'AC'])
                        ->order(['reference DESC', 'category_id ASC'])
                        ->toArray();
        ...
        $results = $this->table->search()
                        ->where([
                                 new Predicate\In('category_id', [12, 10])
                                ])
...
EOF;
    ...
    public function testJoin()
    {
        ...
        $results = $search
            ->join(['c' => 'country'], 'u.country_id = c.country_id')
            ->where(function (Where $where) {
...
EOF;
    ...
    public function testJoinRight()
    {
        ...
        $results = $search
            ->joinRight(['c' => 'country'], 'u.country_id = c.country_id')
            ->where(function (Where $where) {
                $where->like('u.email', '%@example.com');
                $where->like('c.name', 'Unite%');
            });
...
EOF;
    ...
    public function testJoinLeft()
    {
        ...
        $search
            ->joinLeft(['pc18' => "product_category_translation"], "pc18.category_id = pc.category_id")
            ->where(function (Where $where) {
